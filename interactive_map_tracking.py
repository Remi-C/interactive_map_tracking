...
from trackingposition import TrackingPosition
...
class interactive_map_tracking:
    ...
    def __init__(self, iface):
        ...
        self.trackposition = TrackingPosition(self.iface, self.dlg)
    ...
    def init_plugin(self):
        ...
        self.trackposition.slot_returnPressed_threshold()
        #
        #self.slot_refreshComboBoxLayers()
        self.trackposition.slot_refreshComboBoxLayers()
        #
    ...
    def init_signals_gui(self):
        ...
        self.autosave.init()
        self.trackposition.init()

        # self.signals_manager.add_clicked(self.dlg.enableTrackPosition, self.slot_enabled_trackposition, "GUI")
        self.signals_manager.add_clicked(self.dlg.enableTrackPosition, self.trackposition.slot_enabled_trackposition, "GUI")
        ...
        self.signals_manager.add(self.dlg.trackingPositionLayerCombo,
                                 ...
                                 self.trackposition.slot_currentIndexChanged,
                                 "GUI")
    ...
    #         self.values[self.tp_id_user_id] = self.trackposition.tp_user_name
    #
    #     except:
    #         pass
    ...
    #         self.signals_manager.add(self.qgsmap_layer_registry,
    #                                  "layersWillBeRemoved( QStringList )",
    #                                  self.trackposition.slot_LayersWillBeRemoved,
    #                                  "QGIS")
    #
    ...
    def enable_asynch(self):
        ...
        if not (self.dlg.enableUseMutexForTP.isChecked() and self.dlg.enableTrackPosition.isChecked()):
            # self.stop_threads()
            self.trackposition.stop_threads()
    ...
    def enabled_pluging(self):
        ...
        # self.enabled_trackposition()
        self.trackposition.enabled_trackposition()
        self.enable_logging()
        self.enable_asynch()
    ...
    def enabled_pluging_GUI(self):
        ...
        self.signals_manager.add(self.dlg.threshold_extent,
                                 "editingFinished ()",
                                 self.trackposition.slot_returnPressed_threshold)  # use the same slot
